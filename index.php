...
<main>
        ...
        <div class="py-5 text-center container">
            <svg class="d-none" xmlns="http://www.w3.org/2000/svg">
                ...
                <symbol id="zuledu-center" viewBox="0 0 577.2 88.3">
                    <g>
                        <path d="M88.49,87.17H0L45.09,20.82H3.71V0H88.49l-45,66.29h45Z" style="fill: #fff" />
                        ...
                        <path d="M280.06,87.17H213.84V0h26.28V66.29h39.94Z" style="fill: #fff" />
                        ...
                        <polygon points="323.49 69.62 323.49 51.01 360.1 51.01 360.1 33.46 333.2 33.46 323.49 33.46 297.2 33.46 297.2 87.17 362.93 87.17 362.93 69.62 323.49 69.62" style="fill: #fff" />
                    </g>
                </symbol>
            </svg>
            <div class="cta-container">
                ...
                <div>
                    <button class="zuledu-cta-btn" type="button" href="admission.php">Join Our School</button>
                    <button class="zuledu-cta-btn" type="button" href="about.php">Contact Us</button>
                </div>                    
            </div>
        </div>
    </section>
    ...
    <!-- Video -->
    <section class="zuledu-video">
        <div class="container">
            <div class="row">
                <h1 class="pb-2 text-uppercase text-center border-bottom">Latest Videos</h1>
